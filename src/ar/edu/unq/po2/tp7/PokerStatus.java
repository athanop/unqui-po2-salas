...
public class PokerStatus {
	...
	public String verificar(Carta primeraCarta, Carta segundaCarta, Carta terceraCarta, Carta cuartaCarta,
			Carta quintaCarta) {
	...
	public boolean tieneTrio(Carta carta, List<Carta> cartas) {
		return cartas.stream().filter(x -> x.esMismoPalo(carta)).count() == 3;
	}
